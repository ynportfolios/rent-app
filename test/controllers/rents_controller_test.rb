...
class RentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rent" do
    assert_difference('Rent.count') do
      post rents_url, params: { rent: { address: @rent.address, age: @rent.age, name: @rent.name, other: @rent.other, price: @rent.price } }
    end
  ...
  test "should update rent" do
    patch rent_url(@rent), params: { rent: { address: @rent.address, age: @rent.age, name: @rent.name, other: @rent.other, price: @rent.price } }
